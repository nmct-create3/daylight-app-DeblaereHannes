...
const getAPI = async (lat, lon) => {
	...
	const data = await fetch(`http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=1be909d78d94fe08610aacbe62f0c236&units=metric&lang=nl&cnt=1`)
		.then((r) => r.json())
